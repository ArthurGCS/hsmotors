...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($chassi)) {
        $errors[] = "O chassi é obrigat  = "A cor é obrigatória.";
    }
    ...
    if (empty($errors)) {
        try {
            $stmt = $conn->prepare("INSERT INTO veiculos (marca, modelo, ano, placa, cor, chassi, valor, descricao) VALUES (:marca, :modelo, :ano, :placa, :cor, :chassi, :valor, :descricao)");
